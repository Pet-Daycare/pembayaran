...
import id.ac.ui.cs.advprog.b10.petdaycare.pembayaran.core.brand.Dana;
...
public class DanaTest {
    ...
    public void testCreate() {
        ...
        // Verify the values
        assertEquals(expectedAdminFee, dana.getAdminFee());
        assertEquals(expectedCashback, dana.getCashback());
    }
    ...
    public void testCalculateSummaryAmount() {
        ...
        dana.setAdminFee(adminFee);
        dana.setCashback(cashback);

        double expectedSummaryTopUp = cashback.getCashback() - adminFee.getFee();

        // Perform the calculateSummaryAmount method
        dana.calculateSummaryAmount();

        // Verify the value
        assertEquals(expectedSummaryTopUp, dana.getSummaryTopUp());
    }
}
